...
function Home() {
  ...
  const handleAnalyze = () => {
    if (username.trim()) {
      // Handle potential full URL input
        ...
        <div className="w-full max-w-xl relative group">
          ...
          <div className="relative flex items-center bg-[#121215] border border-[#27272a] rounded-xl p-1.5 focus-within:border-purple-500/50 transition-colors shadow-2xl">
            ...
            <button
              ...
              className="bg-purple-600 hover:bg-purple-700 text-white font-medium px-6 py-3 rounded-lg transition-all transform active:scale-95 whitespace-nowrap"
            >
              Analyze →
            </button>
          </div>
